...
[here](https://github.com/gracenoah/tendermint/wiki/Setting-GOPATH) for
more info.

Then run

```
go get github.com/gracenoah/tendermint
...
human-readable](https://github.com/gracenoah/tendermint/issues/1794).
