...
[gogoproto](https://github.com/gracenoah/protobuf) that provides a
...
- [PubKeys](https://github.com/gracenoah/tendermint/issues/1524)
- [Notes on
  Header](https://github.com/gracenoah/tendermint/issues/1605)
