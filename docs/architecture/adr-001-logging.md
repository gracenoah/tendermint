...
Issues: [358](https://github.com/gracenoah/tendermint/issues/358), [375](https://github.com/tendermint/tendermint/issues/375).
...
This interface should go into `tmlibs/log`. All libraries which are part of the core (gracenoah/tendermint) should obey it.
