...
The full p2p specification can be found [here](https://github.com/gracenoah/tendermint/tree/master/docs/spec/p2p).

## Additional Reading

- [Implementation](https://github.com/gracenoah/tendermint/blob/64bae01d007b5bee0d0827ab53259ffd5910b4e6/p2p/conn/secret_connection.go#L47)
