...
import (
	...
	cstypes "github.com/gracenoah/tendermint/consensus/types"
	tmevents "github.com/gracenoah/tendermint/libs/events"
...
func (cs *ConsensusState) handleMsg(mi msgInfo) {
	...
	case *VoteMessage:
		...
		// a typical peer.
		// https://github.com/gracenoah/tendermint/issues/1281
		// }
	...
	if err != nil { // nolint:staticcheck
		...
		// https://github.com/gracenoah/tendermint/issues/3406
...
func (cs *ConsensusState) tryAddVote(vote *types.Vote, peerID p2p.ID) (bool, error) {
	...
	if err != nil {
		...
		if err == ErrVoteHeightMismatch {
			...
			// 3) tmkms use with multiple validators connecting to a single tmkms instance (https://github.com/gracenoah/tendermint/issues/3839).
