...
REPO=github.com/gracenoah/tendermint
go get $REPO
cd $GOPATH/src/$REPO
...
old_ansible_file=$GOPATH/src/github.com/gracenoah/tendermint/networks/remote/ansible/roles/install/templates/systemd.service.j2
rm $old_ansible_file
