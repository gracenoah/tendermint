...
// Examples
//
// - [Tendermint](https://github.com/gracenoah/tendermint/blob/master/rpc/core/routes.go)
// - [tm-monitor](https://github.com/gracenoah/tendermint/blob/master/tools/tm-monitor/rpc.go)
package rpc
