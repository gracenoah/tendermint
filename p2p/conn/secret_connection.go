...
// See https://github.com/gracenoah/tendermint/blob/0.1/docs/sts-final.pdf for
...
// (TODO(ismail): see also https://github.com/gracenoah/tendermint/issues/3010)
...
func computeDHSecret(remPubKey, locPrivKey *[32]byte) (shrKey *[32]byte, err error) {
	...
	// related to: https://github.com/gracenoah/tendermint/issues/3010
	zero := new([32]byte)
...
func incrNonce(nonce *[aeadNonceSize]byte) {
	...
	if counter == math.MaxUint64 {
		...
		// See https://github.com/gracenoah/tendermint/issues/3531
