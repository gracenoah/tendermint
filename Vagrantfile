...
Vagrant.configure("2") do |config|
  ...
  config.vm.provision "shell", inline: <<-SHELL
    ...
    echo 'cd go/src/github.com/gracenoah/tendermint' >> /home/vagrant/.bash_profile

    mkdir -p /home/vagrant/go/bin
    mkdir -p /home/vagrant/go/src/github.com/tendermint
    ln -s /vagrant /home/vagrant/go/src/github.com/gracenoah/tendermint
    ...
    su - vagrant -c 'cd /home/vagrant/go/src/github.com/gracenoah/tendermint && make get_tools && make get_vendor_deps'
  SHELL
end
